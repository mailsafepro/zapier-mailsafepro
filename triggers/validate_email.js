  ...
  operation: {
    inputFields: [
      ...
      },
      {
        ...
        required: false,
        default: false,
        label: '🔄 Verificación SMTP (Premium+)',
        helpText: 'Verificar si el buzón existe realmente (requiere plan PREMIUM o ENTERPRISE)',
      },
      {
        key: 'include_raw_dns',
        type: 'boolean',
        ...
        helpText: 'Incluir registros SPF, DKIM y DMARC completos en la respuesta',
      },
      {
